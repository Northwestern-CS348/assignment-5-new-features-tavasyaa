...
##### Your code to resolveObjectFOPC here -- this will build some FOPC and Assert it
    references = core.resolveObjectFOPC(subject)
...
##### Your code to findAndAttachPrepObjectsFOPC here -- this takes the root, the primary (suibject) and your names
    core.findAndAttachPrepObjectsFOPC(root, subject, references)
...
##### Your code to findAndAssertFeaturesFOPC here -- this takes the root and your names
    core.findAndAssertFeaturesFOPC(root, references)

##### Your code to findAndAssertDefinitionsFOPC -- this takes the root and your names
    core.findAndAssertDefinitionsFOPC(root, references)
